...
for(const file of ['jan-reist.png','manrope.ttf','space-grotesk.ttf','manrope-OFL.txt','space-grotesk-OFL.txt','favicon-blue.svg'])await copyFile(`assets/${file}`,`dist/assets/${file}`);
