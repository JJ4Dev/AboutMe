...
await copyFile('script/request-demo.js','dist/script/request-demo.js');
await copyFile('script/architecture-3d.bundle.js','dist/script/architecture-3d.bundle.js');
await copyFile('assets/three-LICENSE.txt','dist/assets/three-LICENSE.txt');
